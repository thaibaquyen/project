...
<link href="csslogin/popuo-box.css" rel="stylesheet" type="text/css" media="all" />

<!-- Style --> <link rel="stylesheet" href="csslogin/style.css" type="text/css" media="all">
...
<body>
	...
	<div id="small-dialog1" class="mfp-hide">
		<div class="contact-form1">
			<div class="contact-w3-agileits">
				<h3>Register Form</h3>
                <form action="{{ URL::to('/singupcontroler') }}" method="POST">
                {{csrf_field()}}
                        <div class="form-sub-w3ls">
							<input placeholder="Full Name" name="ten"  type="text" required="">
	...
	<!-- pop-up-box-js-file -->  
		<script src="jslogin/jquery.magnific-popup.js" type="text/javascript"></script>
	<!--//pop-up-box-js-file -->
	<script>
